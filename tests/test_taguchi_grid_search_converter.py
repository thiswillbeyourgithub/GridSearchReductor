...
class TestTaguchiGridSearchConverter:
    ...
    def test_init_default(self):
        ...
        assert converter.logger.name == 'TaguchiGridSearchConverter.TaguchiGridSearchConverter'
    ...
    def test_empty_parameter_grid_error(self):
        ...
        with pytest.raises(ValueError, match="must contain at least one parameter with multiple values"):
    ...
    def test_invalid_input_type_error(self):
        ...
        with pytest.raises(TypeError, match="must be either a dictionary or ParameterGrid"):
